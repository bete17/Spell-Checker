...
public interface Dictionary {
    ...
    /**
     * Replaces the current dictionary with words imported from the specified text file.
     * Words in the file are in lexicographical (ASCII) order, one word per line.
     * Trim words before adding them to the tree.
     *
    ...
    /**
     * Loads the specified file from a previously saved dictionary tree file.
     * The file format is text, with one word per line.
     * Trim words before adding them to the tree.
     *
    ...
    /**
     * Adds the given word to the dictionary's binary tree.
     * Do not add any duplicates to the tree.
     * Use .compareToIgnoreCase() for comparisons.
     *
     * @param word
     */
